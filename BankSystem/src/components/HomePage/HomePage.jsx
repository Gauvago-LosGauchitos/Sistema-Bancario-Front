      ...
      {loading ? (
        ...
        <div>
          ...
          <br></br>
            ...
            <div ><p className="parrafo-container">Los ministros de Trabajo de Latinoamérica se reunieron en 1963 para discutir cómo harían propia la Alianza para el Progreso. Emitieron la Declaración de Cundinamarca que recomendaba la creación de bancos que fomentaran el ahorro en los trabajadores y atendieran sus necesidades crediticias. Por ello, el Gobierno de Guatemala emitió el decreto que dio vida al Banco de los Trabajadores.</p></div>
            <br></br>
            <br></br>
            <center><button className='button-home'>Leer más</button></center>
          </div>
          <div className='img-container'><img className='img-home-container' src={imgHome} /></div>
          </div>
        </div>
      )}
    </div>
